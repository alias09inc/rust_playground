...
use actix_web::{ error, get, web, App, HttpRequest, HttpResponse, HttpServer, ResponseError};
use askama::Template;
use r2d2::Pool;
...
async fn main() -> Result<(), actix_web::Error> {
    ...
    conn.execute("CREATE TABLE IF NOT EXSIST todo (
